...
//  GO Passport App
//
//  Created by Eva Arreola on 5/4/18.
...
//
    ...
    class AddContactViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
        ...
        func addContact(repID: String) ->Void {
            let request = NSMutableURLRequest(url: NSURL(string: "https://www.earreola.create.stedwards.edu/finalProject/passportPHP/addContact.php")! as URL)
            request.httpMethod = "POST"
            let postString = "s_id=\(s_id)&r_id=\(repID)"
            ...
            let task = URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
                ...
                DispatchQueue.main.async() {
                    ...
                    if (responseString == "Success")
                    {
                        ...
                        let alertController = UIAlertController(title: "Contact Added", message: "Contact Added", preferredStyle: UIAlertControllerStyle.alert)
